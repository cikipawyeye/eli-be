...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section class="relative" id="about">
            ...
            <div class="px-4 container mx-auto">
                ...
                <div class="grid lg:grid-cols-2 my-auto gap-8">
                    <div class="flex p-8">
                        <img
                            src="/assets/img/landing/feature-1.webp"
                            class="w-full m-auto"
                            alt=""
                        />
                    </div>
                ...
                <div class="grid lg:grid-cols-2 my-auto gap-8">
                    <div class="lg:order-2 flex p-8">
                        <img
                            src="/assets/img/landing/feature-2.webp"
                            class="w-full m-auto"
                            alt=""
                        />
                    </div>
                ...
                <div class="grid lg:grid-cols-2 my-auto gap-8">
                    <div class="flex p-8">
                        <img
                            src="/assets/img/landing/feature-3.webp"
                            class="w-full m-auto"
                            alt=""
                        />
                    </div>
        ...
        <section class="relative">
            <img
                src="/assets/img/landing/app-image.webp"
                class="w-full"
                alt=""
            />
        ...
        <section class="relative py-16" id="testimoni">
            ...
            <div class="px-4 container mx-auto pb-18">
                <div class="py-24">
                    <h2
                        class="text-center font-semibold text-3xl md:text-4xl xl:text-5xl mb-6"
                    >
