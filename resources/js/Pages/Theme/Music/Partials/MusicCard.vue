...
const download = () => {
    if (
        !window.confirm(`Do you want to download music: ${props.music?.title}?`)
    )
        return;

    const imageUrl = props.music.file_url;
    ...
    <div class="w-100 card mt-6" data-animation="true">
        <div class="card-header mt-n4 z-index-2 mx-3 p-0">
            <picture class="d-block">
                <img
                    src="/assets/img/treble-cleft.webp"
                    :alt="music.title"
